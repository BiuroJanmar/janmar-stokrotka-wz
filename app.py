...
st.title("JANMAR WZ-Stokrotka Web v7.0")
st.subheader("Czysty silnik tekstowy (.TXT) działający niezależnie bez szablonów")
st.write("Wgraj surowy plik tekstowy (.TXT) zamówienia ze Stokrotki, aby wygenerować dokument WZ.")
...
if uploaded_file is not None:
    ...
    # Elastyczne czytanie tekstu bez względu na humory przeglądarki
    tekst = None
    ...
    for line_raw in linie:
        # Szukanie 6 cyfr kodu towaru (odporność na przesunięcia)
    ...
    if towary:
        ...
        # Style wizualne Janmar (identyczne jak w Eurocashu)
        ...
        # Wyciąganie dat ze środka pliku
        data_zamowienia = "................"
        data_dostawy = "................"
        ...
        # Generowanie siatki do 60 wiersza (dokładnie tak jak lubicie)
        ...
        # Rozwijana lista krajów pochodzenia
        ...
        st.success(f"Wygenerowano WZ Stokrotka dla zamówienia nr: {nr_zam}")
        st.download_button(
